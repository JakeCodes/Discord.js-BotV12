...
const mouse = "https://www.amazon.com/Rat%C3%B3n-rendimiento-jugar-videojuegos-Logitech/dp/B07GBZ4Q68/ref=sr_1_1?dchild=1&keywords=Logitech+G502+Hero&qid=1597792965&sr=8-1"
    ...
    run: (message, args) => {
        var embed = new MessageEmbed()
            .addFields(
                ...
                {name: 'Mouse', value: `[Logitech G502 Hero](${mouse})`},
